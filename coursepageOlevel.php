 ...
 <img src="logo.jpg" width="100" height="100">
    ...
    <main>
        <div class="course-card">
            <img class="course-img" src="course olevel maths.jpg" alt="Course 1 Image">
        ...
        <div class="course-card">
            <img class="course-img" src="course olevel science.jpg" alt="Course 2 Image">
            <div class="course-info">
                <h2>Science</h2>
        ...
        <div class="course-card">
            <img class="course-img" src="course olevel ICT.jpg" alt="Course 2 Image">
            <div class="course-info">

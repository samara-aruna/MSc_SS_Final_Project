 ...
 <img src="logo.jpg" width="100" height="100">
    ...
    <main>
        <div class="course-card">
            <img class="course-img" src="librarymaths.jpg" alt="Course 1 Image">
            <div class="course-info">
                ...
                <a href="librarymaths.php" class="learn-more-btn">Show Books</a>
            </div>
        </div>

        <div class="course-card">
            <img class="course-img" src="libraryscience.jpg" alt="Course 2 Image">
            <div class="course-info">
                <h2>Science</h2>
                ...
                <a href="libraryscience.php" class="learn-more-btn">Show Books</a>
            </div>
        </div>

        <div class="course-card">
            <img class="course-img" src="librarycs.jpg" alt="Course 2 Image">
            <div class="course-info">
                ...
                <a href="librarycs.php" class="learn-more-btn">Show Books</a>
            </div>
        </div>
